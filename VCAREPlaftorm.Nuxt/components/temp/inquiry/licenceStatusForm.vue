...
<template>
  <div>
    ...
    <div v-if="licenceStatus" class="flex flex-col space-y-3">
      <button
        @click="newInquiry"
          ...
          >
            ...
            <div class="flex flex-col">
              <div class="flex justify-between bg-blue-100 py-2 px-3">
                <p>صاحب گواهینامه</p>
                <p>
                  {{ licenceStatus.firstName }} {{ licenceStatus.lastName }}
                </p>
              </div>
              <div class="flex justify-between py-2 px-3">
                <p>نوع گواهینامه</p>
                <p>{{ licenceStatus.title }}</p>
              </div>
              <div class="flex justify-between bg-blue-100 py-2 px-3">
                <p>شماره ملی</p>
                <p>{{ licenceStatus.nationalNo }}</p>
              </div>
              <div class="flex justify-between py-2 px-3">
                <p>تاریخ صدور</p>
                <p>{{ licenceStatus.printDate }}</p>
              </div>
              <div class="flex justify-between bg-blue-100 py-2 px-3">
                <p>مدت اعتبار</p>
                <p>{{ licenceStatus.validYears }} سال</p>
              </div>
              <div class="flex justify-between py-2 px-3">
                <p>آخرین وضعیت گواهینامه</p>
                <p>{{ licenceStatus.rahvarStatus }}</p>
              </div>
              <div class="flex justify-between bg-blue-100 py-2 px-3">
                <p>بارکد پستی</p>
                <p>{{ licenceStatus.barcode }}</p>
              </div>
            </div>
          </div>
        </div>
    ...
    >
      ...
      >
        ...
        <div v-else class="flex gap-4 items-center">
          ...
          <p>کد ملی و شماره موبایل می‌بایست متعلق به یک فرد باشد.</p>
        </div>
      </div>
      <button
